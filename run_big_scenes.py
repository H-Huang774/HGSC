...
# 指定目录路径
directory_path = "/home/old/huanghe/GS_repository/HGSC/Results/big_scenes"

# 获取目录下的所有文件名
file_names = os.listdir(directory_path)
# file_names = ['room']
xyz_qp = 15
max_points_per_block = 512
percentage = 66
...
for file_name in file_names:
    ...
    subprocess.run(cmd_rec, shell=True, env=dict(os.environ, CUDA_VISIBLE_DEVICES='1'))  # 使用 shell=True 以字符串形式执行命令
